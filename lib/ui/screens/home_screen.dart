...
import 'package:zako/data/tmp_data.dart';
import 'package:zako/ui/screens/introduction_screen.dart';
import 'package:zako/ui/theme/app_theme.dart';
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Find the best', style: Apptheme.tileLarge),
                Text('coffee for you', style: Apptheme.tileLarge),
    ...
    return Row(
      children: [
        CustomIconButton(
          ...
          width: 45,
          height: 45,
          child: const Icon(Icons.widgets, color: Apptheme.iconColor),
        ),
        const Spacer(),
        CustomContainer(
          width: 45,
